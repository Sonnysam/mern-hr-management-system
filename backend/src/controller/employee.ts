...
export const Update = async(req:Request,res:Response) => {
    ...
    try {
        const employee: Employee | null = await employeeModel.findByIdAndUpdate(id,
        {
            name: name,
            email: email,
            position: position,
...
export const Delete = async (req:Request,res:Response) => {
    const id = req.params.id;
    try {
        const deletedEmployee: Employee | null = await employeeModel.findByIdAndDelete(id); 
